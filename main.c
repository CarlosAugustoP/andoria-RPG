...
int main() {
    ...
    */
    ...
    inserir(&history, "Checkpoint 1.2.2.1\nAo escolher a \"Trilha das Lágrimas Sagradas\", você segue o caminho sinuoso até a vila local que margeia essa trilha. Contudo, ao chegar, é recebido por uma cena desoladora: a vila está em ruínas, completamente destruída pelos cavaleiros da Ordem de Nocturia que também buscam o poder da espada de Luminastra. Casas foram incendiadas, e os moradores aterrorizados fugiram em busca de segurança.\nEm meio ao caos, você percebe um camponês indefeso sendo atacado por um cavaleiro sombrio da Ordem. Determinado a proteger os inocentes e enfrentar a ameaça da Ordem de Nocturia, você parte rapidamente para o socorro do camponês. O confronto é inevitável, e a batalha se desenrola em meio às ruas devastadas da vila.\nSEQUENCIA DE COMBATE INICIADA\nSE PREPARE CACADOR\n", 325, 1);

    inserir(&history, "Checkpoint 1.2.2.1.2.1\nO camponês agradecido, ainda ofegante da tortura que sofreu, detalha o atalho que conhece para o Monte Lumina. Ele menciona uma trilha secreta, escondida nas profundezas da floresta adjacente à vila, que serpenteia por entre árvores antigas e riachos cristalinos. Esse caminho menos percorrido, conhecido apenas pelos locais, oferece uma rota mais rápida para o Monte Lumina, evitando as estradas principais que poderiam estar sob vigilância da Ordem de Nocturia.\nO camponês ressalta a importância de seguir as marcas naturais no caminho, como pedras marcadas e árvores específicas, para não se perder nas entranhas da floresta. Ele destaca que o atalho, embora mais rápido, também é repleto de desafios naturais, como terrenos irregulares e a possibilidade de encontrar criaturas selvagens.\nAgora, voce tem duas opcoes: (1) - seguir o atalho do aldeao\n(2) - continuar por sua trilha\n", 337, 0);

    // decidi seguir o atalho do aldeão
    inserir(&history, "Checkpoint 1.2.2.1.2.1.1\nAo seguir o atalho do camponês, você e Sir Cedric exploram um caminho misterioso na floresta, cercado pela densa vegetação e iluminado apenas pela luz filtrada pelas copas das árvores. Durante essa jornada, você se depara com uma criatura rara, cuja presença é quase mitológica na região.\nEsta criatura, conhecida como \"Luminarca\", é uma espécie de ser etéreo com pele resplandecente. Enquanto observa a criatura, Sir Cedric percebe que a carne dela tem propriedades especiais. Sir Cedric sugere que, se consumir a carne da Luminarca, você pode ganhar força adicional.\nAgora, voce tem duas opcoes: (1) - Matar a criatura para ganhar poder (aumente seu HP máximo em 10)\n(2) - Seguir viagem e permitir que o ser misterioso viva.\n", 333, 0);

    // decidi matar a criatura
    inserir(&history, "Checkpoint 1.2.2.1.2.1.1.1\nAo optar por matar a Luminarca e ganhar poder, você se sente fortalecido pela carne da criatura rara, seu corpo pulsando com uma energia renovada. No entanto, à medida que você e Sir Cedric se aproximam do Monte Lumina, a aura misteriosa da floresta cede lugar a um ambiente mais sombrio e tenso.\nAo alcançar o Monte Lumina, você depara-se com uma cena inesperada: um dos líderes do exército da Ordem de Nocturia está presente, liderando uma busca pelo mesmo artefato, a espada \"Luminastra\". Sir Cedric, percebendo a ameaça iminente, sugere que você corra para o monte e busque a espada enquanto ele fica para atrasar o cavaleiro.\nVoce enfrenta uma nova decisao: (1) - ficar e proteger Sir Cedric\n(2) - buscar a espada", 328, 0);

    // decidi fugir
    inserir(&history, "Checkpoint 1.2.2.1.2.1.1.1.1\nAo escolher buscar a espada, você ignora a angústia de deixar Sir Cedric enfrentando os cavaleiros da Ordem sozinho. Ao chegar ao topo do Monte Lumina, uma visão terrível se desenrola à distância: Sir Cedric está sendo devorado pelos cavaleiros da Ordem de Nocturia.\nA cena é avassaladora, e mesmo à distância, a impotência da situação pesa em seu coração. Lágrimas brotam naturalmente de seus olhos, pois a morte de Sir Cedric ocorreu em decorrência da escolha que fez. A dor da perda é profunda, mas você sabe que focar em sua missão é essencial para honrar o sacrifício de seu leal companheiro.\nDeterminado, você segue em direção ao centro do Monte Lumina, onde uma luz irradia em meio ao ambiente desesperador. A luz revela-se como um ser mítico, o anjo Raziel, guardião da espada \"Luminastra\". Agora, diante dessa entidade celestial, sua missão atinge um ponto crucial.\nSeus olhos humanos mal conseguem compreender a magnitude dessa presenca:\n O ser celestial, com sua forma indescritivel, e coberto por inumeras asas resplandecentes que se estendem como um manto de luz.\n Suas penas irradiam cores que vao alem do espectro visivel, criando uma aura hipnotizante de cintilantes matizes que dancam em harmonia.\nSua figura e eterea e sublime, impossivel de ser completamente apreendida pela mente humana.\n\n O ser olha para voce com olhos que parecem conter o conhecimento de todas as eras e galaxias, e sua voz e uma sinfonia celestial que ressoa em sua alma.\n\"OH, DESTEMIDO VIAJANTE, OUSASTE TU ESCALARES O MAJESTOSO MONTE LUMINA EM BUSCA DA LENDARIA ESPADA LUMINASTRA?\", diz o ser celestial.\n\n \"SOU O GUARDIAO VIGILANTE DESTA AREA SAGRADA E O ENVIADO CELESTIAL.\n SAIBA, DISTINTO BUSCADOR DE SONHOS, QUE ANTES DE TE CONCEDER A HONRA DE EMPUNHAR A ESPADA, TU SERAS SUBMETIDO A UMA ESCRUPULOSA AVALIACAO.\nPOIS, DELICADAMENTE, DEVO RESSALTAR QUE MINHA NATUREZA E A DE UM CHERUBIM, UM SER DESIGNADO PARA A PROTECAO DE RELIQUIAS DIVINAS, E ASSIM, A ENTREGA DESTA NOBRE RELIQUIA CARECE DE UMA ESCOLHA REFINADA E PRECISA.\"\n\nA aura divina do ser envolve voce, e voce sente que esta diante de um julgamento que ultrapassa as palavras e os desafios.\n Seu coracao palpita com expectativa.\n\nA decisao sobre sua dignidade e proposito esta nas maos do ser celestial, cuja compreensao vai alem do humano.\n\nA avaliacao esta prestes a comecar...", 330, 0);
